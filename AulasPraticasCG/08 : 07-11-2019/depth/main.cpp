 ...
 * ATIVIDADES:
 *
 * 1 - Alterar o zfar do glFrustum para um valor maior que 200. Por exemplo, 1000.
 * 
 * 2 - Fazer com que a câmera se distancie dos cubos sendo mostrados, de forma animada.
 *
 * 3 - Fazer a câmera rotacionar/orbitar ao redor dos cubos.
 */
...
void initView()
{
	...
	glLoadIdentity();
	glFrustum(-1.0, 1.0, -1.0, 1.0, 1.5, zfar);
